...
|--------|-------------|-------|
| 🤖 [AI Mental Health Therapist Chatbot](https://github.com/Sonu0701/AI-Mental-Health-Therapist-Chatbot) | Empathetic AI chatbot for mental wellness support | Python · LangChain · FastAPI |
| 📄 [AI Resume Screening System](https://github.com/Sonu0701/AI-Powered-Resume-Screening-System) | Automates resume parsing & candidate ranking using NLP | Python · Scikit-learn · FastAPI |
| 🎬 [Movie Recommendation System](https://github.com/Sonu0701/movie-recommendation-system) | Content-based filtering recommendation engine | Python · Pandas · Streamlit |
| 💬 [LangChain Chatbot](https://github.com/Sonu0701/simple-langchain-chatbot) | Conversational AI using LangChain + LLM APIs | Python · LangChain · OpenAI |
